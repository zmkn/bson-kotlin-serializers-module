        ...
        publications {
            create<MavenPublication>("mavenJava") {
                ...
                pom {
                    ...
                    url.set("https://github.com/zmkn/bson-kotlin-serializers-module")
                    inceptionYear.set("2025")
                    licenses {
                        license {
                            name.set("MIT License")
                            url.set("https://github.com/zmkn/bson-kotlin-serializers-module/blob/master/LICENSE")
                        }
                    }
                    developers {
                        developer {
                    ...
                    scm {
                        connection.set("scm:git:https://github.com/zmkn/bson-kotlin-serializers-module.git")
                        developerConnection.set("scm:git:git@github.com:zmkn/bson-kotlin-serializers-module.git")
                        url.set("https://github.com/zmkn/bson-kotlin-serializers-module")
                    }
                }
            }
...
if (localProperties.getProperty("jreleaser.enable") == "true") {
    ...
    configure<org.jreleaser.gradle.plugin.JReleaserExtension> {
        project {
            ...
            links {
                homepage.set("https://github.com/zmkn/bson-kotlin-serializers-module")
                documentation.set("https://github.com/zmkn/bson-kotlin-serializers-module/wiki")
                license.set("https://github.com/zmkn/bson-kotlin-serializers-module/blob/master/LICENSE")
                bugTracker.set("https://github.com/zmkn/bson-kotlin-serializers-module/issues")
                donation.set("https://github.com/zmkn/bson-kotlin-serializers-module")
            }
        }
        signing {
            ...
            maven {
                github {
                    create("github") {
                        ...
                        url.set("https://maven.pkg.github.com/zmkn/bson-kotlin-serializers-module")
